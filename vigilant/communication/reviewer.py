...
"""
    ...
    def _generate_pr_summary_card(
        ...
        lines = [
            ...
            f"| **Advisory notes** | {advisory_count} |",
    ...
    def _compose_markdown(
        ...
        prefix = self._generate_pr_summary_card(pr_intent, verified + likely_vulns, changed_files, advisory_count=len(advisory_comments))
        prefix += "\n\n"
